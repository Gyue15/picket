let cities = {
    ...
    Z: [ "枣阳市", "枣庄", "增城市", "扎赉特旗", "扎兰屯市", "扎鲁特旗", "张家港", "张家界", "张家口", "漳平市", "章丘市", "樟树市", "张掖", "漳州", "湛江", "肇庆", "昭通", "招远市", "浙江", "正蓝旗", "正镶白旗", "郑州", "镇江", "枝江市", "中山", "中卫", "钟祥市", "周口", "舟山", "庄河市", "诸城市", "珠海", "诸暨市", "驻马店", "准格尔旗", "卓尼", "涿州市", "株洲", "淄博", "自贡", "资兴市", "资阳"]
};
let isDown = true;
let cityName = '南京';
